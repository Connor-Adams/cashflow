...
export function slipPreview(slipType: SlipDto['slipType'], boxValues: Record<string, number | string>): string {
  switch (slipType) {
    case 'T4':
      return boxValues.box14 !== undefined ? `box14: $${boxValues.box14}` : '';
    case 'T5':
      return boxValues.box13 !== undefined ? `box13: $${boxValues.box13}` : (boxValues.box24 !== undefined ? `box24: $${boxValues.box24}` : '');
    case 'T3':
      return boxValues.box21 !== undefined ? `box21: $${boxValues.box21}` : '';
    case 'T4A':
      return boxValues.box016 !== undefined ? `box016: $${boxValues.box016}` : (boxValues.box020 !== undefined ? `box020: $${boxValues.box020}` : '');
    case 'T5008':
      return boxValues.box21 !== undefined ? `proceeds: $${boxValues.box21}` : '';
    default:
      return '';
  }
}
