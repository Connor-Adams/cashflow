 ...
 *
 * Pass `endpoint` to override the default `/api/tax/scenarios/compare?kind=personal`
 * — corp scenarios use `/api/tax/scenarios/compare?kind=corp`. The response shape
...
export function useScenarioComparison(
  ids: number[],
  endpoint = '/api/tax/scenarios/compare?kind=personal',
