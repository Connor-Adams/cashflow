...
import type { CorpTaxReturn } from '../../src/tax/engine/types';
...
let rollCorpCarryforwards: typeof import('../../src/tax/services/rollCorpCarryforwards').rollCorpCarryforwards;
...
before(async () => {
  ...
  const rollModule = await import('../../src/tax/services/rollCorpCarryforwards.js');
