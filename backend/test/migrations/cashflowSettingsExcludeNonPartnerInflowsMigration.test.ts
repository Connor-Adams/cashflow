...
before(async () => {
  ...
  createSettingsTable = require('../../src/migrations/20260603100001-create-cashflow-settings.js');
  await createSettingsTable.up(sequelize.getQueryInterface(), Sequelize);

  // eslint-disable-next-line @typescript-eslint/no-require-imports
  migration = require('../../src/migrations/20260606000002-cashflow-settings-exclude-non-partner-inflows.js');
});
