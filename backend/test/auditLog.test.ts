...
let AuditLog: typeof import('../src/models').AuditLog;
...
let diffPatchableFields: typeof import('../src/audit/log').diffPatchableFields;
...
before(async () => {
  ...
  User = models.User;
  const audit = await import('../src/audit/log');
