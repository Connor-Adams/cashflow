...
let reconcileDividendsForSecurity: typeof import('../../src/portfolio/reconcileDividends').reconcileDividendsForSecurity;
...
before(async () => {
  ...
  const reconcileModule = await import('../../src/portfolio/reconcileDividends');
