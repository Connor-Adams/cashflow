...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await addIndex(queryInterface, 'user_reporting_tokens', ['token_hash'], {
      name: 'user_reporting_tokens_token_hash_unique',
      unique: true,
    });
    await addIndex(queryInterface, 'user_reporting_tokens', ['user_id', 'revoked_at'], {
      name: 'user_reporting_tokens_user_active',
    });
  },
