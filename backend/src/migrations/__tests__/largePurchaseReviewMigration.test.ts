...
before(async () => {
  ...
  settingsMigration = require('../20260607100001-cashflow-settings-large-purchase-threshold.js');
});
...
before(async () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  reviewMigration = require('../20260607100002-create-transaction-large-purchase-reviews.js');
});
