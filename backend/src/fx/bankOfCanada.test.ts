...
let FxRate: typeof import('../models/FxRate.js').FxRate;
let fetchBoCRate: typeof import('./bankOfCanada.js').fetchBoCRate;
let ensureFxRate: typeof import('./bankOfCanada.js').ensureFxRate;
...
before(async () => {
  ...
  const boCModule = await import('./bankOfCanada.js');
