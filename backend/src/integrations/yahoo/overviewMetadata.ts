...
export function overviewToMetadata(overview: OverviewResult): SecurityMetadata {
  return {
    ...
    volume24Hr: overview.volume24Hr,
    cryptoStartDate: overview.cryptoStartDate,
    fromCurrency: overview.fromCurrency,
    fundFamily: overview.fundFamily,
    fundCategory: overview.fundCategory,
    fundLegalType: overview.fundLegalType,
    fundExpenseRatio: overview.fundExpenseRatio,
    fundTotalAssets: overview.fundTotalAssets,
    fundYield: overview.fundYield,
    topHoldings: overview.topHoldings,
    sectorWeightings: overview.sectorWeightings,
    bondPosition: overview.bondPosition,
    stockPosition: overview.stockPosition,
    cashPosition: overview.cashPosition,
    trailingReturn1y: overview.trailingReturn1y,
    trailingReturn3y: overview.trailingReturn3y,
