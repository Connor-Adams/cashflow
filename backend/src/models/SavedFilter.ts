...
export const SAVED_FILTER_NAME_MAX = 64;
export const SAVED_FILTER_PAGES = ['transactions'] as const;
  ...
  SavedFilter.init(
    {
      ...
      name: {
        type: DataTypes.STRING(SAVED_FILTER_NAME_MAX),
        allowNull: false,
      },
      page: {
