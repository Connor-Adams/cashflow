...
import reportingV1Router from './routes/reportingV1';
import { requireReportingAuth } from './auth/reportingAuth';
...
app.use('/api/reporting/tokens', reportingTokensRouter);
app.use('/api/v1', requireReportingAuth, reportingV1Router);
