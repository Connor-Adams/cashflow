...
import notificationsRouter, { preferencesRouter as notificationPreferencesRouter } from './routes/notifications';
import notificationPreferencesLegacyRouter from './routes/notificationPreferences';
...
app.use('/api/audit/tokens', auditTokensRouter);  // session-auth
...
app.use('/api/users/me/notifications/preferences', notificationPreferencesRouter);
app.use('/api/notification-preferences', notificationPreferencesLegacyRouter);
