...
let ProviderJobLog: typeof import('../models/ProviderJobLog').ProviderJobLog;
let Household: typeof import('../models/Household').Household;
let runCounterpartyBackfill: typeof import('./counterpartyBackfill').runCounterpartyBackfill;
let isCounterpartyBackfillRunning: typeof import('./counterpartyBackfill').isCounterpartyBackfillRunning;
let getLastCounterpartyBackfillRun: typeof import('./counterpartyBackfill').getLastCounterpartyBackfillRun;
let COUNTERPARTY_BACKFILL_PROVIDER: typeof import('./counterpartyBackfill').COUNTERPARTY_BACKFILL_PROVIDER;
...
before(async () => {
  ...
  const mod = await import('./counterpartyBackfill');
