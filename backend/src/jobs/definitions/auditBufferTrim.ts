// Retention window: 30 days — short enough to keep tables small, long enough
// to debug month-old issues.
...
defineJob({
  ...
  handler: async () => {
    ...
    return { summary: { deleted: clientDeleted + serverDeleted, clientDeleted, serverDeleted } };
  },
});
