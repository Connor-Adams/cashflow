...
// 30-day retention: short enough to keep tables small, long enough to
// debug month-old incidents. Adjust via a follow-up if needed.
...
defineJob({
  ...
  handler: async () => {
    ...
    return { deleted: clientDeleted + serverDeleted };
  },
});
