...
import type { BuildForecastInput } from '../forecast/buildForecast.js';
...
function makeBaselineInput(
  ...
  occurrences: Parameters<typeof import('../forecast/buildForecast.js')['buildForecast']>[0]['occurrences'],
  dateFrom = '2026-06-01',
  dateTo = '2026-06-30',
): BuildForecastInput {
  return {
